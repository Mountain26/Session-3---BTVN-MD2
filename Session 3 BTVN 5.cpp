...
int main(){
	...
	printf("+-----+-----------------+------+---------------+---------------------------+\n");
	printf("| %-3s | %-15s | %-4s | %-13s | %-25s |\n", "4", "Nguyen Van D", "18", "0904488484", "dnv@rikkeiacademy.com");
	printf("+-----+-----------------+------+---------------+---------------------------+\n");
	printf("| %-3s | %-15s | %-4s | %-13s | %-25s |\n", "5", "Nguyen Van E", "19", "0904488485", "env@rikkeiacademy.com");
	printf("+-----+-----------------+------+---------------+---------------------------+\n");
	printf("| %-3s | %-15s | %-4s | %-13s | %-25s |\n", "6", "Nguyen Van F", "22", "0904488486", "fnv@rikkeiacademy.com");
	printf("+-----+-----------------+------+---------------+---------------------------+\n");
